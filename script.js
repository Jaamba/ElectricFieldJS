...
const cariche = [
    new CaricaElettrica(430, 50, 0, 0, 1, false, 0),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 0.2),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 0.4),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 0.6),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 0.8),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 1),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 1.2),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 1.4),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 1.6),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 1.8),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 2),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 2.2),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 2.4),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 2.6),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 2.8),
    new CaricaElettrica(430, 50, 0, 0, 1, false, 3),
...
function animate() {
    ...
    for(let i = 0; i < 16; i++) {
        motoCircolare(cariche[i], 100, 100, 200, 2);
    }
